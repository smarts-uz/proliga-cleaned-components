...
import sty from "./PlasmicRegister.module.css"; // plasmic-import: VVc7zCeBjPCB/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__wot5Q)}
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__ntbR1)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
      ...
      <div className={classNames(projectcss.all, sty.freeBox__jhYxb)}>
        ...
        >
          ...
          >
            ...
            <Button
              data-plasmic-name={"sumbit"}
              data-plasmic-override={overrides.sumbit}
              className={classNames("__wab_instance", sty.sumbit)}
              color={"green"}
              submitsForm={true}
            >
              {"Register"}
          ...
          >
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__hnDuX)}
            >
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__dwLCb)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__okHai)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__jigTq)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
...
const PlasmicDescendants = {
  ...
  login: ["login", "emailInput", "passwordInput", "sumbit"],
...
export const PlasmicRegister = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    sumbit: makeNodeComponent("sumbit"),
